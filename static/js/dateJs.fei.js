 ...
 * */
//日历最外层div样式
var outerStyle = "display: none;position: absolute;z-index: 1000000;width: 314px;margin-top:10px;border: 1px solid #F7F7F7;border-radius: 5px;background-color: #F7F7F7;color: #4eccc4;padding-bottom: 20px;";
//日历控件最外层div
...
function createDate(thisYear, thisMonth) {
	...
	//关闭日历显示
	createDoc += '<span id="closeDate" onClick="hidDate();unshowBackgroundDiv()" style="float: right;font-size: 25px;margin: -20px 3px 0 0;cursor: pointer;">×</span></p></div>';;
